...
You MUST populate at minimum 8 rows. Derive every term from the input — do NOT invent terms or copy from other domains.
...
### Checklist Draft
- `[ACTOR-CAT-NNN]` [Action] → [Expected Result]. *(Promise: ...)*
